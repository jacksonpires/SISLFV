object FormDevolucaoFitas: TFormDevolucaoFitas
  Left = 41
  Top = 111
  Width = 713
  Height = 405
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Devolucao de Fitas'
  Color = clBtnFace
  ...
  object DBGridFitas: TDBGrid
    ...
    Height = 241
    Color = clBtnFace
    DataSource = DMSQL.DsPesquisaDevolucao
  ...
  object BitBtnDevolverFitas: TBitBtn
    Left = 456
    Top = 330
    Width = 153
    Height = 25
    Caption = 'Devolver Fitas Selecionadas'
    TabOrder = 3
    OnClick = BitBtnDevolverFitasClick
  end
